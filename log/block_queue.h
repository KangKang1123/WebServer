...
#ifndef SERVERSIMU_BLOCK_QUEUE_H
#define SERVERSIMU_BLOCK_QUEUE_H
#include <iostream>
#include <stdlib.h>
#include <pthread.h>
#include <sys/time.h>
...
public:
    //初始化私有成员
    block_queue(int max_size = 1000)//默认值1000
    {
        if (max_size <= 0)
        {
            exit(-1);
...
#endif //SERVERSIMU_BLOCK_QUEUE_H
